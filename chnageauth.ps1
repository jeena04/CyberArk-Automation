try
{
    ...
    $logFilePathName = "C:\Users\w3919\Desktop\" + $logFileName
...
$token = Invoke-RestMethod 'APILINK' -Method 'POST' -Headers $headers -Body $body
    $token | ConvertTo-Json
    Add-Content -Path $logFilePathName -Value "AccessToken created successfully"
 
    # User list
    $userIdsFilePath = "USER ID LIST FILE PATH"
